class Posts {
  ...
  List<Null> jetpackPublicizeConnections;
  ...
  Map<String, dynamic> toJson() {
    ...
    data['jetpack_likes_enabled'] = this.jetpackLikesEnabled;
    if (this.lLinks != null) {
...
class Meta {
  ...
  Meta(
      {this.spayEmail, this.jetpackPublicizeMessage, this.jetpackIsTweetstorm});
