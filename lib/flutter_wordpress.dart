...
class WordPress {
  ...
  ///
  /// In case of an error, a [WordPressError] object is thrown.
  Future<List<Page>> fetchPages({ParamsPageList params}) async {
  ...
  ///
  /// In case of an error, a [WordPressError] object is thrown.
  Future<FetchUsersResult> fetchUsers({ParamsUserList params}) async {
    final StringBuffer url = new StringBuffer(_baseUrl + URL_USERS);
  ...
  ///
  /// In case of an error, a [WordPressError] object is thrown.
  Future<List<Tag>> fetchTags({ ParamsTagList params}) async {
  ...
  ///
  /// In case of an error, a [WordPressError] object is thrown.
  Future<List<Media>> fetchMediaList({ ParamsMediaList params}) async {
